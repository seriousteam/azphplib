  ...
  draw : function(container) {
    ...
    columnnode
      .attr("place", function(d) { 
        return d.section=='left' ? 'left' : 'right';
      })
 ...
 /* function close() {
  ...
  function show(ctrl) {
    var ctx = {
      ...
      root: ctrl.A("qe-root"),
      source : ctrl.UA('filter_def') ? new Engine.Source.filterdef(ctrl) : new Engine.Source.uri(),
      button : ctrl,
