...
var QE10 = (function(Engine) {
 /* function close() {
  ...
  function analyzeCtx(ctx) {
    var traversed = {};
    var table = ctx.model[ ctx.root ];
    for(var fieldname in ctx.model) {
  ...
  function show(ctrl) {
    ...
    if(analyzeCtx(ctx)) {
      ...
      alert("Your model contains cycles. Mark any dictionary in your model with 'DICT:' property.");
    }
  }
