...
function checkCtrl(e) {
	...
	if(e.dyn_check_min !== undefined) e.dyn_check = e.dyn_check !== false &&
			sv >= e.dyn_check_min;
	if(e.dyn_check_max !== undefined) e.dyn_check = e.dyn_check !== false &&
			sv <= e.dyn_check_max;
	if(e.dyn_check !== undefined) return e.dyn_check ? clearError(e) : setCtrlError(e);
	return true;
}
